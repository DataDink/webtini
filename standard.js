...
var _StyleBinder = _interopRequireDefault(require("./src/StyleBinder.js"));
var _ClassBinder = _interopRequireDefault(require("./src/ClassBinder.js"));
var _AttributeBinder = _interopRequireDefault(require("./src/AttributeBinder.js"));
 ...
 */
var StandardBinder = exports["default"] = /*#__PURE__*/function (_Binder) {
  function StandardBinder() {
    _classCallCheck(this, StandardBinder);
    for (var _len = arguments.length, extensions = new Array(_len), _key = 0; _key < _len; _key++) {
      extensions[_key] = arguments[_key];
    }
    return _callSuper(this, StandardBinder, [].concat(extensions, [new _TemplateBinder["default"](), new _EventBinder["default"](), new _StyleBinder["default"](), new _ClassBinder["default"](), new _AttributeBinder["default"]()]));
  }
  _inherits(StandardBinder, _Binder);
  return _createClass(StandardBinder);
}(_Binder2["default"]);
window.StandardBinder = StandardBinder;

},{"./src/AttributeBinder.js":2,"./src/Binder.js":3,"./src/ClassBinder.js":4,"./src/EventBinder.js":5,"./src/StyleBinder.js":7,"./src/TemplateBinder.js":8}],2:[function(require,module,exports){
"use strict";
 ...
 * ```
 */
var AttributeBinder = exports["default"] = /*#__PURE__*/function (_Binder$Extension) {
  function AttributeBinder() {
    _classCallCheck(this, AttributeBinder);
    return _callSuper(this, AttributeBinder, arguments);
  }
  _inherits(AttributeBinder, _Binder$Extension);
  return _createClass(AttributeBinder, [{
    key: "handleAttribute",
    value: function handleAttribute(binder, element, route, name, value) {
      var _route$select$value;
      if (!name.startsWith(AttributeBinder.PREFIX)) {
        return false;
      }
      var attr = name.substring(AttributeBinder.PREFIX.length);
      var content = (_route$select$value = route.select(value.split('.')).value) === null || _route$select$value === void 0 ? void 0 : _route$select$value.toString();
      if (content == null && !element.hasAttribute(attr)) {
        return true;
      }
...
},{"./Binder.js":3}],3:[function(require,module,exports){
"use strict";
...
},{"./Route.js":6}],4:[function(require,module,exports){
"use strict";
 ...
 * ```
 */
var ClassBinder = exports["default"] = /*#__PURE__*/function (_Binder$Extension) {
  function ClassBinder() {
    _classCallCheck(this, ClassBinder);
    return _callSuper(this, ClassBinder, arguments);
  }
  _inherits(ClassBinder, _Binder$Extension);
  return _createClass(ClassBinder, [{
    key: "handleAttribute",
    value: function handleAttribute(binder, element, route, name, value) {
      if (!name.startsWith(ClassBinder.PREFIX)) {
        return false;
      }
...
},{"./Binder.js":3}],5:[function(require,module,exports){
"use strict";
...
},{"./Binder.js":3}],6:[function(require,module,exports){
"use strict";
 ...
 * ```
 */
var StyleBinder = exports["default"] = /*#__PURE__*/function (_Binder$Extension) {
  function StyleBinder() {
    _classCallCheck(this, StyleBinder);
    return _callSuper(this, StyleBinder, arguments);
  }
  _inherits(StyleBinder, _Binder$Extension);
  return _createClass(StyleBinder, [{
    key: "handleAttribute",
    value: function handleAttribute(binder, element, route, name, value) {
      var _route$select$result;
      if (!name.startsWith(StyleBinder.PREFIX)) {
        return false;
      }
      var style = _Route["default"].find(element.style, name.substring(StyleBinder.PREFIX.length));
      var setting = (_route$select$result = route.select(value.split('.')).result) === null || _route$select$result === void 0 ? void 0 : _route$select$result.toString();
...
},{"./Binder.js":3,"./Route.js":6}],8:[function(require,module,exports){
"use strict";
